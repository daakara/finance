  ...
  return (
    <header className="border-b border-[#243044] bg-[#0c1017]/95 backdrop-blur sticky top-0 z-50">
      <div className="max-w-[1750px] mx-auto px-2.5 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2">
        ...
        {/* Right: Dual User Journey Role Switcher with Explicit Labels */}
        <div className="flex items-center space-x-2 shrink-0">
          <div className="bg-[#090d14] p-1 rounded-xl border border-[#243044] flex items-center shadow-inner">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg text-[11px] sm:text-xs font-mono font-bold transition-all active:scale-[0.96] transition-transform duration-100 whitespace-nowrap ${
