    ...
    <div className="bg-[#111722] border border-[#243044] rounded-xl p-5 shadow-xl space-y-4 font-mono">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[9px] font-bold px-2 py-0.5 rounded bg-emerald-950/80 text-emerald-300 border border-emerald-800/80 inline-flex items-center gap-1">
              <span>🎯</span> Continuous 30-Day Predictive Realization Audit
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-center">
        ...
        <div className="bg-[#090d14] p-3 rounded-lg border border-[#243044]">
          ...
          <span className="text-[9px] text-emerald-400 block mt-0.5">Passed 5.0% Stress Limit</span>
        </div>

        <div className="bg-[#090d14] p-3 rounded-lg border border-[#243044]">
          <span className="text-[10px] text-slate-400 block uppercase">Live Model Status</span>
          <span className="text-xs font-bold text-amber-400 block truncate mt-1">Active & Synced</span>
          <span className="text-[9px] text-slate-500 block mt-0.5">Regime Factor Calibrated</span>
        </div>
      </div>
