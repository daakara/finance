...
export default function ComparisonPairPage({ params }: PageProps) {
  ...
  const priceA = factorA ? factorA.price : (parseFloat(itemA?.price?.replace(/[^0-9.]/g, "") || "100.00"));
  const priceB = factorB ? factorB.price : (parseFloat(itemB?.price?.replace(/[^0-9.]/g, "") || "100.00"));
