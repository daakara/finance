...
export const MASTER_ASSET_CATALOG: Record<string, MasterAssetEntry> = {
  ...
  SMCI: {
    ...
    verdict: "High-Beta Squeeze Setup",
    moatSummary: "Building-block server architecture allowing rapid time-to-market for newest silicon chips.",
    upcomingCatalyst: "Direct-to-chip liquid-cooling delivery scale and audit governance resolution.",
